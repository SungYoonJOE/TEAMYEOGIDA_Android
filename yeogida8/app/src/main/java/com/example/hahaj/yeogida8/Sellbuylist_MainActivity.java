...
public class Sellbuylist_MainActivity extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener{
    ...
    sell_Fragment fragment1;
    buy_Fragment fragment2;
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sellbuylist_activity_main);
        ...
        Log.d("sellbuy의 메인 personpid :", ""+personpid);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        else if(id == R.id.sell_buy) {// 구매,판매내역 화면
            Toast.makeText(this,"구매/판매 내역 화면입니다", Toast.LENGTH_LONG).show();
