...
public class Likedlist_MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    Likedlist_Fragment sellFragment;
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sellFragment =new Likedlist_Fragment();
        ...
        tabs.addTab(tabs.newTab().setText("찜 상품"));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        else if(id == R.id.myReservation) {//찜한 상품 목록화면
            Toast.makeText(this,"찜한 상품 화면 입니다", Toast.LENGTH_LONG).show();
            //Intent intent_liked = new Intent(getApplicationContext(), Likedlist_MainActivity.class);
            //Log.d("인텐트","나와라3");
            //startActivity(intent_liked);
        }

        else if(id == R.id.recentView) {//최근 본 상품목록으로 이동.
