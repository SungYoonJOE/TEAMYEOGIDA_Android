...
public class Recentlist_MainActivity extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener{
    ...
    Recentlist_Fragment sellFragment;
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sellFragment =new Recentlist_Fragment();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.myItem) {//내상품 화면으로 이동
            Toast.makeText(this,"내 상품 화면으로 이동", Toast.LENGTH_LONG).show();
        ...
        else if(id == R.id.recentView) {//최근 본 상품목록
            Toast.makeText(this,"최근 본 목록입니다", Toast.LENGTH_LONG).show();
